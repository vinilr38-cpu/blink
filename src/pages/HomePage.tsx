            ...
            <div className="flex flex-col items-center justify-center pt-4">
              {!isJoining ? (
                <div className="flex flex-col sm:flex-row gap-4 justify-center w-full">
                  <Button size="lg" className="px-8" onClick={createSession} disabled={isCreating}>
                    <Mic className="h-5 w-5 mr-2" />
                    {isCreating ? 'Creating...' : 'Create Session'}
                  </Button>
                  <Button size="lg" variant="outline" className="px-8" onClick={() => setIsJoining(true)}>
                    <Users className="h-5 w-5 mr-2" />
                    Join Session
                  </Button>
                </div>
              ) : (
                <form onSubmit={handleManualJoin} className="w-full max-w-sm space-y-4 animate-in fade-in zoom-in duration-300">
                  <div className="relative">
                    <input
                      ...
                      maxLength={6}
                      className="w-full px-6 py-4 text-center text-2xl font-bold tracking-widest bg-white border-2 border-primary/20 rounded-2xl focus:border-primary focus:outline-none transition-all shadow-lg"
                    />
                  </div>
                  <div className="flex gap-2">
                    ...
                    <Button type="button" size="lg" variant="ghost" onClick={() => setIsJoining(false)}>
                      Cancel
                    </Button>
                  </div>
                </form>
